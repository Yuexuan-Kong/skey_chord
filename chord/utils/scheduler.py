...
def get_network_momentum(
    ...
    values = [(warmup_init_value, momentum_teacher), (momentum_teacher, 1)]
...
def get_temp_teacher_schedule(
    ...
    return get_temp_schedule(
        n_epochs, temp, temp_final, temp_init, warmup_epochs, schedule_epochs
    )
